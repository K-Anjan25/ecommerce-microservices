...
> | 10 — Hardening | **Baseline complete / ongoing**; CI, dark mode, authorization, rate limits, correlated JSON logs, backup/restore, PWA, en/hi i18n and zero-known-vulnerability frontend dependency baseline done |
