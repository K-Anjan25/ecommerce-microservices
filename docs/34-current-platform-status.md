...
5. **High-assurance SEO rendering.** A crawler policy, generated sitemap/robots assets, and static public fallback shells exist; data-aware SSR/pre-rendered product HTML remains.
