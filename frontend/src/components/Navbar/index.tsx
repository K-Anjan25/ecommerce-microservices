...
const Navbar = () => {
  ...
  return (
    <AppBar position="static" sx={{ bgcolor: "primary.main", color: "primary.contrastText", boxShadow: "none" }}>
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <IconButton aria-label="cart" onClick={() => navigate("/cart")} color="inherit">
            {carts.length > 0 ? (
          ...
          {user.isLogedIn ? (
            ...
            <Box sx={{ display: "flex" }}>
              <Button variant="contained" color="secondary" fullWidth sx={{ minWidth: "6rem" }} onClick={() => navigate("/login") }>
                Login
              </Button>
              <Button variant="contained" color="secondary" fullWidth sx={{ marginLeft: "0.5rem", minWidth: "6rem" }} onClick={() => navigate("/register") }>
                Register
              </Button>
            </Box>
          )}
