...
export const en = {
  ...
  "home.heroCta": "Shop Now",
    "subscribe.title": "Subscribe & save",
  "subscribe.subtitle": "Never run out — we place the reorder, you just pay and receive.",
  "subscribe.every": "Deliver every",
  "subscribe.deliverEvery": "Deliver every",
  "subscribe.days": "days",
  "subscribe.cta": "Start subscription",
  "subscribe.success": "Subscription started — manage it from Your Subscriptions.",
  "subscribe.error": "Could not start the subscription",
