...
public class EmailConstant {
    ...
    public static final String USERNAME = "kyamaanjan2@gmail.com";
    public static final String PASSWORD = "izpqppvgontrdwxp";
    public static final String FROM_EMAIL = "kyamaanjan2@gmail.com";
